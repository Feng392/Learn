    ...
    children: [
      {
        id: 1,
        content:
          "beijing beijingbeijingbeijingbeijingbeijingbeijingbeijingbeijingbeijingbeijingbeijingbeijingbeijingbeijingbeijingbeijingbeijingbeijing",
      },
    ],
  },
  {
...
<template>
  ...
  <div class="box">
    ...
    >
      <div class="header">
        <div :class="{ icon: true, active: currentId === item.id }">></div>
